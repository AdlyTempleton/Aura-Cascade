...
public class ThaumcraftHelper {
    ...
    /**
     * @param entity The string ID of the entity
     * @param toadd  A list of comma-separated aspects for scanning the entity<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item           The {@link ItemStack} to add aspects to.
     * @param toadd          A list of comma-separated aspects for scanning the ItemStack<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @param craftedAspects True if the item should inherit aspects from its crafting ingredients
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item  The {@link ItemStack} to add aspects to. <ol>Will <b>inherit aspects</b>.</ol>
     * @param toadd A list of comma-separated aspects for scanning the ItemStack<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item           The {@link Item} to add aspects to.
     * @param meta           The metadata of the Item
     * @param toadd          A list of comma-separated aspects for scanning the Item<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @param craftedAspects True if the item should inherit aspects from its crafting ingredients
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item           The {@link Item} to add aspects to. <ol>Will apply to <b>all metadatas</b>.</ol>
     * @param toadd          A list of comma-separated aspects for scanning the Item<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @param craftedAspects True if the item should inherit aspects from its crafting ingredients
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item  The {@link Item} to add aspects to. <ol>Will <b>inherit aspects</b>.</ol>
     * @param meta  The metadata of the Item
     * @param toadd A list of comma-separated aspects for scanning the Item<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item  The {@link Item} to add aspects to. <ol>Will apply to <b>all metadatas</b>. <br>Will <b>inherit aspects</b>.</ol>
     * @param toadd A list of comma-separated aspects for scanning the Item<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item           The {@link Block} to add aspects to.
     * @param meta           The metadata of the Block
     * @param toadd          A list of comma-separated aspects for scanning the Block<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @param craftedAspects True if the item should inherit aspects from its crafting ingredients
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item           The {@link Block} to add aspects to. <ol>Will apply to <b>all metadatas</b>.</ol>
     * @param toadd          A list of comma-separated aspects for scanning the Block<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @param craftedAspects True if the item should inherit aspects from its crafting ingredients
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item  The {@link Block} to add aspects to. <ol>Will <b>inherit aspects</b>.</ol>
     * @param meta  The metadata of the Block
     * @param toadd A list of comma-separated aspects for scanning the Block<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
    ...
    /**
     * @param item  The {@link Block} to add aspects to. <ol>Will apply to <b>all metadatas</b>. <br>Will <b>inherit aspects</b>.</ol>
     * @param toadd A list of comma-separated aspects for scanning the Block<ol><b>entry format</b>: '<code>\d+ .+</code>'</ol>
     * @throws Throwable Any errors caused by reflection
     */
